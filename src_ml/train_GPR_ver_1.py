...
def generate_candidates_lhs(N):
    ...
    Ip_min,  Ip_max  = 0.1, 2.0
    B0_min,  B0_max  = 0.5, 4.0
    nbar_min, nbar_max = 0.1, 3.0 # in units 10^19 m^-3
...
if __name__ == "__main__": 
    ...
    Y_train, sigma_n, Y_mean, Y_std = scale_Y(Y_train, sigma_n)
    print(Y_train)
    print(sigma_n)
    ...
    # Finally, extract the maximum point from the GP
    x_best, mu_best, sigma_best = extract_maximum(X_train, Y_train, lengthscales, sigma_f, sigma_n,5000)
    print("Current maximum prediction at:")
    print(x_best)
    print("With mean:", descale_Y(mu_best, Y_mean, Y_std))
    print("And uncertainty:", descale_Y(sigma_best, Y_mean, Y_std))
...
if __name__ == "__main__": 
    ...
    for round_idx in range(1, n_rounds + 1):
        ...
        # check if folder exists, warn if not
